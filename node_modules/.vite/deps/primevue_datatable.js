import {
  script as script4
} from "./chunk-3A2PFULH.js";
import "./chunk-EHQR2FIZ.js";
import "./chunk-UX43XGQ6.js";
import {
  script as script3
} from "./chunk-P6YMMY7A.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-VP2AROP4.js";
import {
  script as script2
} from "./chunk-P5H2HR3Z.js";
import {
  OverlayEventBus
} from "./chunk-TNI72SWR.js";
import {
  script
} from "./chunk-TKZZU3SN.js";
import {
  Ripple
      ...
      createBaseVNode("tr", _hoisted_2$5, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.columns, (col, i) => {
          return openBlock(), createElementBlock(Fragment, {
            ...
            }, null, 8, ["column", "groupRowsBy", "groupRowSortField", "resizableColumns", "sortMode", "sortField", "sortOrder", "multiSortMeta", "allRowsSelected", "empty", "filters", "filterDisplay", "filtersStore"])) : createCommentVNode("", true)
          ], 64);
        }), 128))
      ]),
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("tbody", {
    ...
    !$props.empty ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList($props.value, (rowData, index) => {
      ...
      createBaseVNode("td", { colspan: $options.columnsLength }, [
        $props.templates.empty && !$props.loading ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.empty), { key: 0 })) : createCommentVNode("", true),
        $props.templates.loading && $props.loading ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.loading), { key: 1 })) : createCommentVNode("", true)
      ], 8, _hoisted_6$1)
    ]))
  ], 4);
}
...
var primevue_datatable_default = script5;
export {
